...
# -*- coding: utf-8 -*-
"""
Fix Long Content Pages - 長いコンテンツを分割して処理
"""
...
def split_long_content(content: str, max_length: int = 1800) -> List[str]:
    """長いコンテンツを適切に分割"""
...
def create_page_with_split_content(title: str, content_data: Dict[str, Any]) -> str:
    """長いコンテンツを分割してページを作成"""
    try:
        # バックアップデータからコンテンツを取得
        ...
        # 長いコンテンツを分割
        content_chunks = split_long_content(formatted_content)
...
def main():
    ...
    for i, page_data in enumerate(failed_pages, 1):
        ...
        # 新しいページを作成（長いコンテンツを分割）
        print(f"  新しいページを作成中（長いコンテンツを分割）...")
        new_page_id = create_page_with_split_content(title, page_data)
